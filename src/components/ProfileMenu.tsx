      ...
      <SheetContent side="left" className="w-64">
        <div className="space-y-4 mt-8">
          ...
          <div className="space-y-1">
            <h3 className="text-xs font-semibold text-muted-foreground px-4 py-2">
              Menu
            </h3>
            <Link
              to="/edit-profile"
          ...
          <div className="border-t pt-4">
            <button
              ...
              className="w-full flex items-center gap-2 px-4 py-2.5 rounded-lg text-destructive hover:bg-destructive/10 transition-colors"
            >
